...
import MonumentBuilder from "../app/catalunya-omap-monument";
import MockData from './mockBuildingData';

jest.mock("../app/catalunya-omap-manager", () => {
    ...
    describe("addCastells", () => {
        it("should add markers for each castell to the map", () => {
            ...
            expect(mapBuilder.mapManager.addMarker).toHaveBeenCalledWith({
                ...
                icon: "http://localhost/images/militar/castell/castell7.png",
                icon2: "http://localhost/images/militar/castell/castell6.png",
                category: "castell",
...
describe("Private Methods - Helper functions", () => {
    ...
    describe("_getIcon", () => {
        it("should construct the icon URL correctly", () => {
            ...
            expect(url).toBe("http://localhost/images/militar/castell/castell1.png");
        });
    });
