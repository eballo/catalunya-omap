...
module.exports = (env, argv) => {
    ...
    const entries = {
        dist: { import: './src/app/catalunya-omap-main', filename: `./dist/${argv.mode}/catalunya-omap.min.js` },
        web:  { import: './src/app/catalunya-omap-main', filename: `./web/js/catalunya-omap.min.js` },
    };
    ...
    if (env && env.plugin) {
        ...
        entries.wp = {
            import: './src/app/catalunya-omap-main',
            filename: path.relative(path.resolve(__dirname), path.join(pluginPath, 'plugins/refreshMap/pages/js/catalunya-omap.min.js')),
        };
    }
